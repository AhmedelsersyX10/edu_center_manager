...
import 'package:edu_center_manager/features/groups/presentation/view/widgets/custom_desktop_group_card_list.dart';
import 'package:edu_center_manager/features/teachers/data/models/teacher_model.dart';
import 'package:flutter/material.dart';

class GroupsDesktopList extends StatelessWidget {
  const GroupsDesktopList({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: CustomAnimatedSwitcher(
        ...
        child: CustomDesktopGroupCardList(
          groups: groups,
