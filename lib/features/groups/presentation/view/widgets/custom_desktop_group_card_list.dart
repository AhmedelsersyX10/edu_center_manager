...
class CustomDesktopGroupCardList extends StatefulWidget {
  const CustomDesktopGroupCardList({
    super.key,
  ...
  @override
  State<CustomDesktopGroupCardList> createState() => _CustomDesktopGroupCardListState();
}

class _CustomDesktopGroupCardListState extends State<CustomDesktopGroupCardList> {
  ...
  @override
  void didUpdateWidget(CustomDesktopGroupCardList oldWidget) {
