...
import 'package:edu_center_manager/features/groups/presentation/view/widgets/groups_desktop_list.dart';
...
class GroupsViewBodyDesktop extends StatelessWidget {
  const GroupsViewBodyDesktop({super.key});
